...
Tal ves se vea un poco confuso pero trtaremos de ilustrar mejor el metodo con un ejemplo, Asi:
...
gr_polinomio = 5 // Esto contendra el grado del polinomio
...
1- Tomamos la secuncia de datos **D** y le agregamos tantos 'ceros' nos diga el grado del polinomio, para nuestro ejemplo el grado del polinomio generador es 5 por lo tanto tendremos lo siguiente:   **D** + 00000, entonces:
